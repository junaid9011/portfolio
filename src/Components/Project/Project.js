...
const Project = () => {
    return (
        ...
        <div className=" mx-auto  md:m-4 h-auto grid-cols-1 grid-rows-3  rounded-md w-60 shadow hover:shadow-xl hover: transition duration-500 ease-in-out hover:  text-3xl transform hover:-translate-y-1 hover:scale-110">
            ...
            <div className="">
                <a className=" text-white bg-red-600 h-10 w-11/12 align-middle  rounded-md mb-4 border hover:text-red-500 hover:bg-white hover: border-red-500" href="https://rongginbakso.netlify.app/" rel="noreferrer" target="_blank">Demo</a>
