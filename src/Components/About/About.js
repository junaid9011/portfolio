...
const About = () => {
    ...
    return (
       <div id="about-section" data-aos="fade-up" className='pt-2'>
            ...
            <h1 className="text-center  relative text-4xl text-medium text-red-500 mt-10 ">ABOUT</h1>
            <div  className="md:flex justify-evenly md:mt-4">
                ...
                <br />
                 ...
                 <p className=" mr-4 md:text-justify px-3 ">A <span className="highlight">Web Developer.</span>
                 <br />
                 <br />
